      ...
      <Container as={Stack} maxW={'7xl'} py={10}>
        <SimpleGrid
         columns={"5"}
          ...
          <Stack spacing={6}>
            <Box>
             <Image width={'70%'} src='https://bonito.in/wp-content/themes/bonito-cms/assets/new-images/logo.svg' />
            </Box>
            ...
            <Box>
              ...
              <Flex width={"100%"}>
              <Image p={"5px"} width={"40%"} src="https://d3gq2merok8n5r.cloudfront.net/play-store-1663167874-52PHa.png"/>
              <Image p={"5px"} width={"40%"} src="https://d3gq2merok8n5r.cloudfront.net/store-badges-1663167618-cP16A/app-store-1663167801-pqWsv.png"/>
              </Flex>
            </Box>
          </Stack>
          <Stack align={'flex-start'}>
            <ListHeader>OFFERINGS</ListHeader>
            <Box as="a" href={'#'}>
              About us
            </Box>
            <Box as="a" href={'#'}>
          ...
          <Stack align={'flex-start'}>
            <ListHeader>GET INSPIRED</ListHeader>
            <Box as="a" href={'#'}>
              Help Center
            </Box>
            <Box as="a" href={'#'}>
